...
def test_resolve_pricing_model_keeps_claude_sonnet_4_6_on_its_own_tier():
    assert resolve_pricing_model("claude-sonnet-4-6") == "claude-sonnet-4-6"


def test_estimate_text_token_cost_uses_claude_sonnet_4_6_pricing():
    ...
    assert pricing_model == "claude-sonnet-4-6"
